  ...
  return (
    <div className="flex flex-col h-full bg-[#050709] overflow-y-auto overflow-x-hidden">
      ...
      <PageHeader 
        ...
        description="Global telemetry and operational intelligence across all normalized events."
        actions={
      ...
      <div className="p-6 space-y-6 max-w-[1600px] mx-auto w-full">
        ...
        <div className="grid grid-cols-4 gap-4">
          <StatBlock title="Total Events" value="14.2M" trend={12.4} icon={Activity} />
          <StatBlock title="Auth Failures" value="124.5K" trend={4.2} icon={ShieldAlert} />
          <StatBlock title="Avg Latency" value="2.1ms" trend={-1.5} icon={Zap} />
          <StatBlock title="Active Parsers" value="42" trend={0} icon={LayoutGrid} />
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="col-span-2 bg-[#0a0d12] border border-[#1e2d3d] rounded-lg p-5">
             <div className="flex justify-between items-center mb-6">
                <h3 className="text-[#e2e8f0] text-sm font-semibold tracking-tight">Ingestion Volume by Severity</h3>
             ...
             <div className="h-[280px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={VOLUME_DATA} margin={{ top: 5, right: 0, left: -20, bottom: 0 }}>
                    <defs>
          ...
          <div className="bg-[#0a0d12] border border-[#1e2d3d] rounded-lg p-5 flex flex-col">
            <h3 className="text-[#e2e8f0] text-sm font-semibold tracking-tight mb-6">Event Category Distribution</h3>
        ...
        <div className="grid grid-cols-3 gap-6 pb-12">
          ...
          <div className="bg-[#0a0d12] border border-[#1e2d3d] rounded-lg p-5">
            <h3 className="text-[#e2e8f0] text-sm font-semibold tracking-tight mb-4">Top Source IPs</h3>
            <div className="space-y-3">
              {TOP_IPS.map((item, i) => (
          ...
          <div className="bg-[#0a0d12] border border-[#1e2d3d] rounded-lg p-5">
            <h3 className="text-[#e2e8f0] text-sm font-semibold tracking-tight mb-4">Top Users (Auth Failures)</h3>
            <div className="space-y-3">
              {TOP_USERS.map((item, i) => (
                <div key={i} className="flex items-center justify-between group">
                  <div className="flex items-center gap-3">
                    <span className="text-[#64748b] text-[10px] font-mono w-3">{i + 1}.</span>
          ...
          <div className="bg-[#0a0d12] border border-[#1e2d3d] rounded-lg p-5">
            <h3 className="text-[#e2e8f0] text-sm font-semibold tracking-tight mb-4">Parser Performance Pipeline</h3>
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-[#1e2d3d]">
                  <th className="pb-2 text-[#64748b] text-[10px] uppercase font-bold tracking-widest font-mono">Parser</th>
                  <th className="pb-2 text-[#64748b] text-[10px] uppercase font-bold tracking-widest font-mono text-right">Vol</th>
                  <th className="pb-2 text-[#64748b] text-[10px] uppercase font-bold tracking-widest font-mono text-right">Latency</th>
                </tr>
              </thead>
